...
//        }
    ...
    public void ListNevCreate(){
        ...
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_mynetbarg, "پروفایل فروشندگان","nprofile2",false);
        ...
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_category, "انتخاب دسته بندی","select cat",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_logout, "خروج","exit",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_bullet, "درباره","about",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_bullet, "ارتباط با ما","ContactUs",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_bullet, "اطلاعات تماس","contact the",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_bullet, "اطلاعیه ها","information",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_bullet, "اشتراک در خبرنامه","share news",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_bullet, "قوانین و مقررات","rules",false);
        drawerItemNav[i++] = new ObjectDrawerItem(R.drawable.sm_ic_bullet, "شبکه های اجتماعی","social network",false);
    ...
    private void SelectItem(String code)
    {
        ...
        switch (code) {
            ...
            case "nprofile"://ورود
                if(!IsEmptyDV("id"))
                    PublicStaticValues.newpage="http://www.takhfif2020.ir/MobilePage/Mobile_Profile.aspx?usrId="+GetDV("id");
                else
                    PublicStaticValues.newpage="tk_login.html";
                break;
            case "join":
                PublicStaticValues.newpage="http://www.takhfif2020.ir/MobilePage/Mobile_signup.aspx";
                break;
            case "nprofile2":// پروفایل فروشندگان
                if(!IsEmptyDV("id"))
                {
                    String ut=GetDV("ut");
                    if (ut.contains("7"))
                        PublicStaticValues.newpage = "http://www.takhfif2020.ir/MobilePage/Mobile_AdminProfile.aspx?usrId=" + GetDV("id");
                    else
            ...
            case "contact the"://تماس با ما
                ...
                break;
            case "ContactUs":
                PublicStaticValues.newpage = "http://www.takhfif2020.ir/MobilePage/Mobile_ContactUs.aspx";
                SetDV("citylocation","");
                break;
            default:
                break;
